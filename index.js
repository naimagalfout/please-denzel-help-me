...
{
  newdebaters.push(debaters[index].toUpperCase());
}
...
//We have information about Zach Shirey, one image with 2 size different, 
...
//Paypal - Netflix and sncf

// Q17. Describe an ESILV project that you worked on that you’re proud of?
//My ping project was my best project in ESILV!  We created a prototype of a car in the future and we made it to the final of the twizy competition. 
//I was the project manager, everything was perfect. 
//I have manage 10 people and I really liked that. We work in collaboration with Renault and Segula.

// Q18. Describe an ESILV project that you worked on that you’re not so proud of?
// in my PI2 project there was very bad communication in the team and I don't like that.

// Q19. What are some things you like about the developer tools you use?
//I like when things are simple and easy to use
...
//The title has an 's' in architectureS because there is not just one architecture for creating a web application, there are several Web Application Architecures.
//An architecture cannot suffice the types of existing sites.
// There is different back/front end ....